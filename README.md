...
![Requests](https://img.shields.io/badge/Requests-20232A?style=for-the-badge\&logo=python\&logoColor=3776AB)
...
A Python-based system designed to monitor and process court case information from publicly available court data.
...
A data-driven platform focused on presenting and analyzing urban information to make complex city data easier to understand.
...
* Rainfall and weather-related data
* API-based data
